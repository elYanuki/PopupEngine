class PopupEngine{
	 ...
	 * @param {function} confirm anonymous function that will be executed if the user confirms, leave empty to do nothing
	 * @param {function} cancel anonymous function that will be executed if the user cancels, leave empty to do nothing
	 */
	static createPopup(text, confirm, cancel) {
		if(!this.initialized){
			console.error("PopupEngine has not been initialized: PopupEngine.init()")
			return
		}
